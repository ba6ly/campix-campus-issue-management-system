...
const studentNavItems = [
  ...
  { to: '/student/status', icon: ClipboardList, label: 'Track Status' },
  ...
  const navItems = role === 'admin' 
    ? [
        ...
        ...(user?.role === 'super_admin' ? [
          { to: '/admin/requests', label: 'Pending Requests', icon: UserCheck },
    ...
    <>
      ...
      <nav style={{ flex: 1, padding: '16px 0' }}>
        ...
        {filteredNavItems.length > 0 ? (
          ...
          <p style={{ padding: '8px 20px', fontSize: '0.75rem', color: 'var(--color-text-muted)', fontStyle: 'italic', margin: 0 }}>No pages found</p>
        )}
      </nav>
