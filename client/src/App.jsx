        ...
        <SocketProvider>
          <Routes>
            ...
            <Route path="/admin" element={
              ...
              <Route path="requests" element={<ProtectedRoute role="super_admin"><PendingRequests /></ProtectedRoute>} />
              <Route path="roles" element={<ProtectedRoute role="super_admin"><RoleManagement /></ProtectedRoute>} />
            </Route>
